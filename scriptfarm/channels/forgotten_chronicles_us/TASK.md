...
OUTPUT FORMAT — scene-based JSON, one object per 3-5 second screen cut:
  ...
  "sfx"    — "dramatic-sting" | "thunder" | "whoosh" | "ting" | null
...
For this niche, typical visuals include: ancient ruins, historical paintings, artifact close-ups, maps
Primary SFX for key reveals: "dramatic-sting"
Authority proof source: archaeological records
...
SCENES:
[
  {"vo": "[First punchy sentence setting up the core problem.]", "visual": "[ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null},
  {"vo": "[Key statistic with source attribution.]", "visual": "[text-popup or chart animation showing the number]", "sfx": "dramatic-sting"},
  {"vo": "[Build tension — what happens if they do nothing.]", "visual": "[consequence visual matching niche: ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null},
...
SCENES:
[
  {"vo": "[Continue story or data. Short punchy sentence.]", "visual": "[ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null},
  {"vo": "[Key insight or data point with source.]", "visual": "[chart or text popup — sepia-gold]", "sfx": "thunder"},
  ...
  {"vo": "[Bridge to next point.]", "visual": "[ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null}
]

SEGMENT 3: [Heading]
SCENES:
[
  {"vo": "[Continue with next data point or evidence.]", "visual": "[ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null},
  {"vo": "[Key data — most surprising finding.]", "visual": "[chart or graphic — concrete data]", "sfx": "dramatic-sting"},
  ...
  {"vo": "If ancient history just broke your brain a little — tap Like. That is why we do this.", "visual": "[presenter smiling, relaxed, direct camera]", "sfx": "ting"}
]

SEGMENT 4: [Heading]
SCENES:
[
  {"vo": "[Continue with solution or key action step.]", "visual": "[ancient ruins, historical paintings, artifact close-ups, maps]", "sfx": null},
  {"vo": "[Most actionable takeaway — specific and concrete.]", "visual": "[chart, comparison, or step graphic]", "sfx": null},
  {"vo": "I went deeper on this in another video — the link is pinned in the comments.", "visual": "[presenter gestures to side or below]", "sfx": null}
]

SEGMENT 5: [Heading — resolve BOTH open loops from segments 1 and 3]
SCENES:
[
  {"vo": "[Resolve open loop from segment 1 — deliver the exact payoff promised.]", "visual": "[the reveal: specific number, chart, or comparison]", "sfx": "dramatic-sting"},
  {"vo": "[Key resolution data — the proof the payoff is real.]", "visual": "[chart or animation showing result]", "sfx": null},
  {"vo": "[Resolve open loop from segment 3 — deliver that payoff too.]", "visual": "[second reveal — concrete visual]", "sfx": "dramatic-sting"},
...
6. LENGTH IS MANDATORY: total vo words across ALL scenes MUST be 1800-2100
   words (a ~12-minute video at ~150 wpm). A short script is a FAILURE — YouTube
   needs 8+ minutes of content to enable mid-roll ads. Since each scene is capped at 25
   words, you MUST write MANY scenes (84+ total) to reach the word count.
7. Each SEGMENT's SCENES array MUST contain 10-16 scenes (the examples above show only
   ...
   substantive scenes (more data points, examples, mini-stories) until total ≥ 1800 words.
