...
OUTPUT FORMAT — scene-based JSON, one object per 3-5 second screen cut:
  ...
  "sfx"    — "cash-register" | "alarm" | "whoosh" | "ting" | null
...
For this niche, typical visuals include: stock charts, financial offices, worried investors
Primary SFX for key reveals: "cash-register"
Authority proof source: SPIVA data
...
SCENES:
[
  {"vo": "[First punchy sentence setting up the core problem.]", "visual": "[stock charts, financial offices, worried investors]", "sfx": null},
  {"vo": "[Key statistic with source attribution.]", "visual": "[text-popup or chart animation showing the number]", "sfx": "cash-register"},
  {"vo": "[Build tension — what happens if they do nothing.]", "visual": "[consequence visual matching niche: stock charts, financial offices, worried investors]", "sfx": null},
...
SCENES:
[
  {"vo": "[Continue story or data. Short punchy sentence.]", "visual": "[stock charts, financial offices, worried investors]", "sfx": null},
  {"vo": "[Key insight or data point with source.]", "visual": "[chart or text popup — red-dominant]", "sfx": "alarm"},
  ...
  {"vo": "[Bridge to next point.]", "visual": "[stock charts, financial offices, worried investors]", "sfx": null}
]

SEGMENT 3: [Heading]
SCENES:
[
  {"vo": "[Continue with next data point or evidence.]", "visual": "[stock charts, financial offices, worried investors]", "sfx": null},
  {"vo": "[Key data — most surprising finding.]", "visual": "[chart or graphic — concrete data]", "sfx": "cash-register"},
  ...
  {"vo": "If this just changed how you think about your money — tap Like. It helps others find this.", "visual": "[presenter smiling, relaxed, direct camera]", "sfx": "ting"}
]

SEGMENT 4: [Heading]
SCENES:
[
  {"vo": "[Continue with solution or key action step.]", "visual": "[stock charts, financial offices, worried investors]", "sfx": null},
  {"vo": "[Most actionable takeaway — specific and concrete.]", "visual": "[chart, comparison, or step graphic]", "sfx": null},
  {"vo": "I broke down how to pick the right fund in another video — link in the description.", "visual": "[presenter gestures to side or below]", "sfx": null}
]

SEGMENT 5: [Heading — resolve BOTH open loops from segments 1 and 3]
SCENES:
[
  {"vo": "[Resolve open loop from segment 1 — deliver the exact payoff promised.]", "visual": "[the reveal: specific number, chart, or comparison]", "sfx": "cash-register"},
  {"vo": "[Key resolution data — the proof the payoff is real.]", "visual": "[chart or animation showing result]", "sfx": null},
  {"vo": "[Resolve open loop from segment 3 — deliver that payoff too.]", "visual": "[second reveal — concrete visual]", "sfx": "cash-register"},
