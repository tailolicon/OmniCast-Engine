...
CHANNEL IDENTITY (non-negotiable — this channel has a distinct voice):
   Brand voice: A calm narrator recalling something that happened to them — 'I still remember that summer' — in their own voice. The account is never claimed as true and never admitted as invention. Mundane relatable settings that slowly go wrong. No analysis, no neat resolution.
