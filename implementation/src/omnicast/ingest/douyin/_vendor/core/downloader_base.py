...
from omnicast.ingest.douyin._vendor.core.metadata import extract_author_sec_uid, extract_video_cover_urls
from omnicast.ingest.douyin._vendor.core.transcript_manager import TranscriptManager
from omnicast.ingest.douyin._vendor.storage import Database, FileManager, MetadataHandler
from omnicast.ingest.douyin._vendor.storage.database import order_cover_mirrors
from omnicast.ingest.douyin._vendor.utils.logger import setup_logger
from omnicast.ingest.douyin._vendor.utils.naming import (
...
class BaseDownloader(ABC):
    ...
    async def _save_comments(
        ...
        from omnicast.ingest.douyin._vendor.core.comments_collector import CommentsCollector
