...
from omnicast.ingest.douyin._vendor.core.downloader_base import BaseDownloader, DownloadResult
from omnicast.ingest.douyin._vendor.core.metadata import extract_author_sec_uid
